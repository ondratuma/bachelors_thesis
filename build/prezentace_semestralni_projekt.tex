...
\line{\hsize=.5\hsize \vtop{%
        \clabel[Akord A]{Akord A}
        \picw=6cm \inspic {../assets/images/mapfir_input_format.png}
        \caption/f Akord A~\cite[chord]
   \par}\vtop{%
        \clabel[3/4 doprovod]{3/4 doprovod}
        \picw=5cm \inspic {../assets/images/mapfir_output_format.png}
        \caption/f 3/4 doprovod~\cite[doprovod]
   \par}}
\endinsert
