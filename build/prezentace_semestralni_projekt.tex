...
* propose plan to create GUI
* try to merge projects with different build systems
* decision to split into multiple applications
* prepare tooling and distributed datastructures
* implement GUI
