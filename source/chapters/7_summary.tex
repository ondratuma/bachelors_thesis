...
Furthermore, I'd like to introduce one additional criteria that was not mentioned in the assignment, that is, however, quite important when the main outcome is a software. This criteria being the user experience.
It has been discussed in the chapter {\ref[system_properties]}, and based on the outcome, it is concluded to be more than satisfactory, enhancing user experience greatly when compared to the original project.\br
