...
At first, the {\mapfIR} project was analysed in order to identify key features, and decide which ones are desirable in the final software. Afterwards, the {\oldRepo} was reviewed to determine the current state of development and provide us with the ability to determine the path to the final goal. Then, the selected software design was discussed. The final stage of the project was the implementation.\br
