...
Furthermore, I'd like to introduce one additional criteria that was not mentioned in the assignment, that is, however, quite important when the main outcome is a software. This criteria being th user experience when using the software, and even the ability to use the software. It proved to be 
