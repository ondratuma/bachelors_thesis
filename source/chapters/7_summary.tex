...
Future steps will probably include the addition of new synchronization algorithms (\ref[synchronization_strategy]) and introduction of in-app rerouting, incorporating selected algorithms supported by {\mapfIR} and enabling easy addition and development of custom algorithms. 
