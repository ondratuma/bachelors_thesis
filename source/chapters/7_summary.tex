...
The criteria mentioned in the assignment were successfully fulfilled. But from the actual usage of the original software arose one criteria that was not mentioned, and that I'd like to introduce. The user experience when using the software, and even the ability to use the software.
