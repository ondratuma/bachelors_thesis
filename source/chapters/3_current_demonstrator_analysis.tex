...
\sec Components
The whole demonstration framework consisted of 2 distinct parts communicating over TCP in the local network.
\secc Server
The server compenent was expected to be run at static IP address "192.168.2.4".
\secc Robots
