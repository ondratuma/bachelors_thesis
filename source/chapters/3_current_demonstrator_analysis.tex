...
\secc Robots
The base of the softwaere running on robots consists of ROS package, module responsible for navigation on the grid and simple communication layer executing commands received from the server.
