...
The coordinate system representation in the file is independent on the rotation of the whole coordinate system. It is, by convention expected to begin in the lower left corner of the imaginary grid, growing linearly to the upper right corner of the grid. The rotation of the coordinate system plays role only on the physical robots, therefore keeping the convention common across both components simplifies the potential visualization of the plans, and makes it simpler to imagine the final plan without the need to perform multidimensional rotations.
