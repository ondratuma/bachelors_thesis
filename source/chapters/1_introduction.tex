...
\sec Current state
Currently, the workgroup of Intelligent and Mobile robotics at CIIRC is is operating a demonstrator of autonomous warehouse robots. The version of the demonstrator is part of the {\oldRepo} that enables only basic functionality for the simulations, which mainly include:
