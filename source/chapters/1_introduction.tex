...
Its main purpose is the execution of a solution to a pathfinding problem. The problem usually consists of a number of agents with assigned starting points, and a set of goals that the agents have to arrive to.
