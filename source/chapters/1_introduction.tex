...
The current data representation format is XML-based. It is not compatible with {\mapfIR} (Described in detail in {\link[ref:chap_2]{\Black}{\it Chapter 2}}) input nor output format, which makes the software at its current state useless for students developing algorithms for the {\mapfIR} solver. 
