...
\sec The goal
The general motivation for this work is to improve software for autonomous warehouse demonstrations currently used by the The Intelligent and Mobile Robotics Group (IMR). 
