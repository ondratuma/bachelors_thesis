...
The current data representation format is XML-based. It is not compatible with input nor output format {\mapfIR} (Described in {\link[ref:chap_2]{\Black}{\it Chapter 2}}), which makes the software at its current state useless for students developing algorithms for the {\mapfIR} solver. 
