...
The IMR also experiments with the {\mapfIR} project, a software-only solution for generation and visualization of similar plans (described in {\link[ref:chap_2]{\Black}{\it Chapter 2}}).
