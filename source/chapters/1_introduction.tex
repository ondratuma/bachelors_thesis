...
As part of the EU solution of the {\safeLog}, a laboratory demonstrator with TurtleBot robots was created for trajectory planning for a group of robots in an automated warehouse. The aim of the thesis is to get acquainted with this environment and develop it further. The specific procedure is as follows:
\begitems \style n
...
\sec Current state
Currently, the The Intelligent and Mobile Robotics Group (IMR) at CIIRC is is operating a demonstrator of autonomous warehouse robots. The version of the demonstrator is part of the {\oldRepo} that enables only basic functionality for the simulations, which mainly include:
