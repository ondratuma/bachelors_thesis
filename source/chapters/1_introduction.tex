...
Another significant goal is the introduction of GUI, which would enable the user to setup demonstration settings, and to interact with the system during the demonstration run.
