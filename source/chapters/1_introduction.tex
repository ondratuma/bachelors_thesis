...
\sec Current state
Currently, the The Intelligent and Mobile Robotics Group (IMR) at CIIRC is operating a demonstrator of autonomous warehouse robots. The version of the demonstrator is part of the {\oldRepo} that enables only basic functionality for the simulations, which mainly include:
