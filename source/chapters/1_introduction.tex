...
{\link[ref:chap_2]{\Black}{\it Chapter 2}} analyzes the {\mapfIR} project, to help us understand the formats it uses, and simplify further development. \ref[chap_3]{Chapter 3} analyzes the current state of the software used, as a basic prerequisite for its enhancement. \ref[chap_4]{Chapter 4} goes over implementation decisions for the creation of the final software, while \ref[chap_5]{Chapter 5} describes the actual implementation details. \ref[chap_6]{Chapter 6} sums up the workflow and user experience and compares the old and new software. \ref[chap_7]{Chapter 7} serves as the summary of this thesis.