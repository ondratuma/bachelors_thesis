...
\begitems \style n
    * Provides event loop synchronized with framerate
    * Interacting with the canvas using framework apis
    * Provides rich set of GUI widgets (buttons, text fields, etc.)
\enditems
with the only downside being it's dependence on \makefile