...
The first one is \ofxCMake. Its attempt is to provide the package as {\of} addon. Unfortunately, the latest version is from Aug 13, 2017, and there seems to be no active development keeping it in sync.