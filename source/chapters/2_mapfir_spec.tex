...
Hierarchical Cooperative A* and Windowed Hierarchical Cooperative A* \cite[Silver_2021], PIBT \cite[ijcai2019-76], CBS \cite[SHARON201540], ICBS \cite[Boyarski2015ICBSTI], ECBS \cite[Barer2014SuboptimalVO], Revisit Prioritized Planning [6], Push and Swap [7], winPIBT [8], PIBT+, and IR (Iterative Refinement).
