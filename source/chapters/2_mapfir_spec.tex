...
\sec Introduction
{\mapfIR} is a simulator and visualizer of Multi-Agent Path Finding (MAPF) \cite[mapfir_repo]. It is written in C++(17). Its main appeal for us is the ease of use and the usage of human-readable input and output formats that are generally easy to understand.\br\br
