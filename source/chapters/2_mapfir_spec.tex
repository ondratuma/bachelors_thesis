...
Hierarchical Cooperative A* and Windowed Hierarchical Cooperative A* \cite[Silver_2021], PIBT [2], CBS [3], ICBS [4], ECBS [5], Revisit Prioritized Planning [6], Push and Swap [7], winPIBT [8], PIBT+, and IR (Iterative Refinement).
