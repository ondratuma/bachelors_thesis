...
The solver is a standalone \cmake application and the visualizer is using openFrameworks as in our case. This split is necessary as described in {~\ref[choosing_gui]}. The general workflow is to run the solver on a problem set as described in {~\ref[mapfir_solver_input]}
