...
\begmulti 2
{\bf The solver} is a standalone {\cmake} application. It generates a simple CLI binary executable, that allows the user to generate an execution plan based on a problem definition. It supports multiple planning algorithms, that can be switched using command line arguments. \vfil\break 
