...
8,21,2,18
\endtt
The input format is illustrated above. It starts by the name of a map file on the first line, followed by the number of agents on the second, followed by the seed of the problem, followed by two time configuration options.
