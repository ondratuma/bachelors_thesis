...
\sec Introduction
{\mapfIR} is a simulator and visualizer of Multi-Agent Path Finding (MAPF). It is written in C++(17). It uses human-readable input and output formats, that are generally easy to understand.
.\br\br
