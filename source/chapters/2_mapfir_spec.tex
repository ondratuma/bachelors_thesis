...
\begmulti 2
The solver is a standalone {\cmake} application. \vfil\break The visualizer is based on {\of} and is built using {\makefile}. This split is necessary as described in {~\ref[choosing_gui]}. The general workflow is to:
\endmulti
\begitems \style n
