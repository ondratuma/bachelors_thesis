...
In this chapter I will take a detailed look at the inner workings of {\mapfIR} project. The purpose of this chapter is to also point out differences in formats and inner workings that we need to migrate in order to achieve full copmatibility.
