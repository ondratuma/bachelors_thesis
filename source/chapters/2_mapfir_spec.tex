...
On the $5^{th}$ line, starts the actual map represented by [height] rows and [width] columns. Each grid tile is represented by single ASCII character. Currently, only 2 characters are used. 
\begitems \style x
