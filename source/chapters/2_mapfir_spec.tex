...
\sec Introduction
{\mapfIR} is a simulator and visualizer of Multi-Agent Path Finding (MAPF). It is written in C++(17). Its main appeal for us is the ease-of-use and the usage human-readable input and output formats, that are generally easy to understand.\br\br
...
Hierarchical Cooperative A* and Windowed Hierarchical Cooperative A* \cite[Silver_2021], PIBT (Priority Inheritance with Backtracking) \cite[ijcai2019-76], CBS (Conflict-based search) \cite[SHARON201540], ICBS (Iterative Conflict-based search) \cite[Boyarski2015ICBSTI], ECBS (A Bounded-Suboptimal Search variant of CBS) \cite[Barer2014SuboptimalVO], Revisit Prioritized Planning \cite[7138650], Push and Swap \cite[Luna2011PushAS], winPIBT \cite[Okumura2019winPIBTEP], and IR (Iterative Refinement).
