...
The input format is illustrated above. The file starts with the name of a map file on the first line, continuing with the number of agents on the second line, followed by the seed (used only as a reference to how the problem was generated) of the problem and by two time configuration options.
