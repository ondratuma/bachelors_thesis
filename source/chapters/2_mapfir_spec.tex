...
In this chapter, I will take a detailed look at the inner workings of the {\mapfIR} project. The purpose of this chapter is also to point out differences in formats and inner workings that might play an important role during implementation.
