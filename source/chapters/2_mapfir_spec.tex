...
\midinsert
\clabel[mapfir_gui_2]{mapf-IR GUI with direct lines}
\picw=14cm \cinspic {../assets/images/mapfir_gui_2.png}
\caption/f mapf-IR GUI with direct lines
\endinsert
