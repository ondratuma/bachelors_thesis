...
\secc{Input format}
The input is description of the pathfinding problem that is given to the solver, which in turn tries to create a solution for given problem set.
\ttline 0
\begtt
map_file=arena.map
agents=300
...
\secc{Output format}
The output file is solution to a given pathfinding problem on a given map, with additional metadata included.
\ttline 0
\begtt
