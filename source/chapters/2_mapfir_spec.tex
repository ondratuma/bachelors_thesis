...
The solver is a standalone {\cmake} application and the visualizer is based on {\of} and is built using {\makefile}. This split is necessary as described in {~\ref[choosing_gui]}. The general workflow is to:
\begitems \style n
