...
\begitems \style x
    ...
    * {\bf The visualizer} is based on {\of} (openFrameworks) and is built using {\makefile}. It is used to visualize the output of the solver once it has been generated. The user is able to change the visualization speed and highlight particular robots.\break 
\enditems
