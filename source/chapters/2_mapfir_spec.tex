...
\begmulti 2
The solver is a standalone {\cmake} application. It is a simple cli binary executable, that allows the user to generate execution plan based on problem definition. It supports multiple planning algorithms, that can be switched using command line arguments. \vfil\break 
