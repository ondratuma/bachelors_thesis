...
\sec Introduction
{\mapfIR} is a simulator and visualizer of Multi-Agent Path Finding (MAPF) \cite[MAPFIR:REPO_DESCRIPTION]. It is written in C++(17). Its main appeal for us is the ease of use and the usage of human-readable input and output formats that are generally easy to understand.\br\br
...
\begitems \style x
    ...
    * {\bf The visualizer} is based on openFrameworks ({\of}) and is built using {\makefile}. It is used to visualize the output of the solver once it has been generated. The user is able to change the visualization speed and highlight particular robots.
\enditems
