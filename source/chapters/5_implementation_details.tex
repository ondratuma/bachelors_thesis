...
The Server is a central part of the project, communicating with the frontend and robots. Robots and Frontend communicate only with the server and are completely independent of each other.
\secc Communication
