...
\vfil \break
\secc Demonstration
In Figures {~\ref[adg_step_1]}-{~\ref[adg_step_15]}, you can see part of the execution using ADG. The Figures are not spaced evenly relative to the simulation time. Instead, they were selected to represent significant events during the execution. \br
