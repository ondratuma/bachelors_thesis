...
The tracking works by placing special tracking markers, as can be seen on Figure \ref[vicon_markers], and mapping each marker constellation to an identifier in the Vicon software. The system then automatically tracks the position, rotation and speed of each marker constellation.
\midinsert
\clabel[vicon_markers]{Communication sequence diagram}
