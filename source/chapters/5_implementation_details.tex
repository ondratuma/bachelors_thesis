...
The translation from Vicon coordinate system to the base one happens on the server right after the reception of Vicon data and no other system component is aware of the different coordinate systems used by Vicon.
