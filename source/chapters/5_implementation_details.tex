...
\begitems \style x
    ...
    * multiple ports for frontend connections (1 for each message type. e.g. viconPositions, robotPositions, robotCommandExecuted, robotCommandBlocked, robotCommandFinished)
    ** test
\enditems
