...
The server code resides in the /FleetControl/modules/manager directory. The only other code it touches should be the {Shared resources}~\ref[shared_resources].\br
