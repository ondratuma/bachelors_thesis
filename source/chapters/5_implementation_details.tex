...
The translation from base to Robot and in reverse happens on the robot, and no other system component is aware of the different coordinate system used by Robots.
