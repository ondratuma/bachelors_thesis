...
All relevant application information about robots has been moved to a single place. It is in a file named "robot_definitions.txt" in the root of the project. Description of each robot consists of its ID, IP address, port used 
