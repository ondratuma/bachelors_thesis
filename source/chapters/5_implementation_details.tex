...
\line{\hsize=.3333333333\hsize \vtop{%
        \clabel[Výchozí obrázek na obrazovce]{Výchozí obrázek na obrazovce}
        \picw=4cm \cinspic {../assets/images/new_ui_adg_1.png}
        \caption/f Výchozí obrázek na obrazovce
   \par}\vtop{%
        \clabel[Vzhled EV3 Kostky během hry]{Vzhled EV3 Kostky během}
        \picw=4cm \cinspic {../assets/images/new_ui_adg_1.png}
        \caption/f Vzhled EV3 Kostky během hry
   \par}\vtop{%
        \clabel[Vzhled EV3 Kostky během pomlky]{Vzhled EV3 Kostky během pomlky}
        \picw=4cm \cinspic {../assets/images/new_ui_adg_1.png}
        \caption/f Vzhled EV3 Kostky během pomlky
   \par}}
\endinsert