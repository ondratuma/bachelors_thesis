...
The red robot continues to wait, until the next node in its desired path is free (from the ADG perspective). Meaning that every robot, who planned to travel through the node before this one, did so already.
\midinsert
