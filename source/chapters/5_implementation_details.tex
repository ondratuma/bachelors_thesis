...
\finalGrid
The coordinate system used across the system is relative to the output of the solver. Starting at point (0, 0) in the lower left corder of the demonstration grid just for convention.
