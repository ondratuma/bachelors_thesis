...
The server code resides in the "{projectRoot}/FleetControl/modules/manager" directory. The only other code it touches should be the {Shared resources} described in section ~\ref[shared_resources].\br
