...
The message types are associated with the following use-cases.
\begitems \style x
    * transfer of Vicon positions
    * transfer of Robot positions
...
viconPositions, robotPositions, robotCommandExecuted, robotCommandBlocked, robotCommandFinished
