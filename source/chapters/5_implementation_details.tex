...
The server code resides in the /FleetControl/modules/app directory. The only other code it touches should be the {Shared resources}~\ref[shared_resources].\br
...
The server is the only component of the application, that is aware of more than one other component. It serves as a central point for all other components. It communicates with the frontend, with each of the robots and {\vicon}.
