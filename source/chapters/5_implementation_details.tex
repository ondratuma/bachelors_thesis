...
The Server is central part of the project, communicating with the frontend and robots through the Messenger interface. Robots and Frontend communicate only with the server and are completely independent of each other.
\sec TurtleBot build
