...
\line{\hsize=.3333333333\hsize \vtop{%
        ...
        \picw=4.5cm \cinspic {../assets/images/new_ui_adg_1.png}
        \caption/f Step 1
   \par}\vtop{%
        \clabel[adg_step_2]{Step 2}
        \picw=4.5cm \cinspic {../assets/images/new_ui_adg_3.png}
        \caption/f Step 2
   \par}\vtop{%
        \clabel[adg_step_3]{Step 3}
        \picw=4.5cm \cinspic {../assets/images/new_ui_adg_4.png}
        \caption/f Step 3
   \par}}
\endinsert
\midinsert
\line{\hsize=.3333333333\hsize \vtop{%
   ...
   \picw=4.5cm \cinspic {../assets/images/new_ui_adg_5.png}
   \caption/f Step 4
\par}\vtop{%
   \clabel[adg_step_5]{Step 5}
   \picw=4.5cm \cinspic {../assets/images/new_ui_adg_6.png}
   \caption/f Step 5
\par}\vtop{%
   \clabel[adg_step_6]{Step 6}
   \picw=4.5cm \cinspic {../assets/images/new_ui_adg_7.png}
   \caption/f Step 6
\par}}
\endinsert
\midinsert
\line{\hsize=.3333333333\hsize \vtop{%
   ...
   \picw=4.5cm \cinspic {../assets/images/new_ui_adg_8.png}
   \caption/f Step 7
\par}\vtop{%
   \clabel[adg_step_8]{Step 8}
   \picw=4.5cm \cinspic {../assets/images/new_ui_adg_9.png}
   \caption/f Step 8
\par}\vtop{%
   \clabel[adg_step_9]{Step 9}
   \picw=4.5cm \cinspic {../assets/images/new_ui_adg_10.png}
   \caption/f Step 9
\par}}
\endinsert
\midinsert
\line{\hsize=.3333333333\hsize \vtop{%
   ...
   \picw=4.5cm \cinspic {../assets/images/new_ui_adg_11.png}
   \caption/f Step 10
\par}\vtop{%
   \clabel[adg_step_11]{Step 11}
   \picw=4.5cm \cinspic {../assets/images/new_ui_adg_12.png}
   \caption/f Step 11
\par}\vtop{%
   \clabel[adg_step_12]{Step 12}
   \picw=4.5cm \cinspic {../assets/images/new_ui_adg_13.png}
   \caption/f Step 12
\par}}
\endinsert
\midinsert
\line{\hsize=.3333333333\hsize \vtop{%
   ...
   \picw=4.5cm \cinspic {../assets/images/new_ui_adg_14.png}
   \caption/f Step 13
\par}\vtop{%
   \clabel[adg_step_14]{Step 14}
   \picw=4.5cm \cinspic {../assets/images/new_ui_adg_15.png}
   \caption/f Step 15
\par}\vtop{%
   \clabel[adg_step_15]{Step 15}
   \picw=4.5cm \cinspic {../assets/images/new_ui_adg_16.png}
   \caption/f Step 16
\par}}
\endinsert