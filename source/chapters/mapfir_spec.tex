...
\secc{input format}
\mapfirInputFormat 
The input format is as illustrated on ~\ref[mapfir_input_format] starting by name of map file on the first line, followed by number of agents on the second, 
