...
\secc{Input format}
\mapfirInputFormat 
The input format is as illustrated on ~\ref[mapfir_input_format] starting by a name of map file on the first line, followed by number of agents on the second, followed by the seed of the problem, followed by two time configuration options.
