...
\sec The visualizer
The visualizer uses input file conforming to the format described in {~\ref[mapfir_solver_output_format]} to visualize the run of the generated simulation. It lets the user change the simulations speed and move through discrete time steps. Other features include selecting only single agent to display, stopping agent during simulation and visual features such as hiding/showing of lines to goals.
\mapfirGui 