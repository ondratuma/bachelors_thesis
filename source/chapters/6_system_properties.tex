...
\begitems \style x
    ...
    * {./ciirc-exec.sh server:update} - performs a hard reset of the tracked brach and pulls the latest changes from the VCS on the server and fixes permissions for executable files.
...
\begitems \style x
    ...
    * {./ciirc-exec.sh robots:update <robotId>} -  performs a hard reset of the tracked brach and pulls the latest changes from the VCS on the robot and fixes permissions for executable files.
