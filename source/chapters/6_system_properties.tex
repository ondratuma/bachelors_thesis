...
\begitems \style x
    ...
    * {./ciirc-exec.sh server:update} - performs a hard reset of the tracked branch and pulls the latest changes from the VCS on the server, and fixes permissions for executable files.
...
\begitems \style x
    * {./ciirc-exec.sh robots:ssh <robotId>} - opens an interactive shell in the root of the project on the robot
    * {./ciirc-exec.sh robots:init <robotId>} - performs initial cloning of the repository
    * {./ciirc-exec.sh robots:update <robotId>} -  performs a hard reset of the tracked branch and pulls the latest changes from the version control system (VCS) on the robot, and fixes permissions for executable files.
