...
This section describes the process before the demonstration can be run. It includes updates from source code, build of the robots, server, set up of the connections and synchronizing all elements of demonstration. \br
