...
\begitems \style x
    ...
    * {./ciirc-exec.sh robots:update <robotId>} -  performs a hard reset of the tracked branch and pulls the latest changes from the VCS on the robot, and fixes permissions for executable files.
