...
It was then decided, that it would be most beneficial to split the GUI into separate application and keep using the framework as intended by the authors.
