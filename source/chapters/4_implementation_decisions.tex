...
\hfill \break
There appear to be a few attempts to do this. Unfortunately, the vast majority of them are out of date and unusable without heavy modifications. During the preparation for this thesis, I tried to se tup all of them, without success, as they are out of date. Below are few example approaches to this problem.
