...
It was then decided that the plan would be synchronized between both applications on simulation start or plan change. Any messages regarding the robot's positions will strictly refer to the synchronized plan.
