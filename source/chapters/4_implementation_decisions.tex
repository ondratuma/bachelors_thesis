...
The first one being {\ofxCMake}. It attempts to provide the package as {\of} add-on. Unfortunately, the latest version is from Aug 13, 2017, and there seems to be no active development keeping it in sync. 
