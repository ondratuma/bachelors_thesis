\abstractEN {
    ...
    The final software should significantly improve the developer experience for future students developing algorithms for the {\mapfIR} solver, enhance the impression when presenting to $3^{rd}$ parties, and provide overall better user experience
    }
\thanks {
