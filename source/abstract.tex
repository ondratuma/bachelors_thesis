\abstractCZ {
    Tato práce analyzuje a vylepšuje demonstrátor robotů pro automatizované sklady využívaný na pracovišti CIIRC.
    Hlavním úkolem této práce je vylepšit stávající software, přidat nové funkcionality a umožnit použítí formátu kompatibilního s {\mapfIR} projektem. 
...
\abstractEN {
    This work analyzes and improves upon the multi-agent planning system demonstrator currently used at the Czech Institute of Informatics, Robotics and Cybernetics.
